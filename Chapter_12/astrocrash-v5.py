# Astrocrash05
# Addition of the countdown timer, more Ship class constants
# and handling asteroid collisions correctly
# Shifted ship definition around so it is defined before the Ship class init def!
